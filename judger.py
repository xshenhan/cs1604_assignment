...
TASKS = [
    ('1_task1', ['engine.cpp','field.cpp','units.cpp','main.cpp']),
    ('2_task2', ['engine.cpp','field.cpp','units.cpp','main.cpp']),
    ('3_task3', ['engine.cpp','field.cpp','units.cpp','main.cpp']),
    ('4_task4', ['engine.cpp','field.cpp','units.cpp','main.cpp']),
]
...
def compile_and_link(args, task, workdir):
    ...
    src_paths = [
        os.path.join(args.thisdir, 'source', src)
        for src in srcs
    ]
